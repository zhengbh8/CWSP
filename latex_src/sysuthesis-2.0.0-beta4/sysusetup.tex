...
\DeclareCaptionFont{tablefive}{\zihao{5}\songti\setstretch{1}}
\captionsetup[table]{
  name=表,
  labelsep=space,
  position=top,
...
\AtBeginEnvironment{table}{\zihao{5}\songti\setstretch{1}}
\AtBeginEnvironment{longtable}{\zihao{5}\songti\setstretch{1}}
